...
# client.transfer_spot_to_isolated_margin(asset="USDT",symbol=symbol, amount=23)

# client.transfer_isolated_margin_to_spot(asset="USDT",symbol=symbol, amount=23)
...
#     history = get_history_transfer(transFrom="SPOT" , transTo="ISOLATED_MARGIN", symbol=symbol, asset="USDT",size=1)
