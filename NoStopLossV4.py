...
pairs = ["FILUSDT","SLPUSDT","WINUSDT","BAKEUSDT","AUDIOUSDT", "BTTUSDT", "SXPUSDT","UNIUSDT", "DOGEUSDT", "CELRUSDT","ONEUSDT","CHRUSDT","DGBUSDT","ICXUSDT","WAVESUSDT","ZRXUSDT"]
log_file = "./StrategyTests/NoStopLossV4"
#endregion
